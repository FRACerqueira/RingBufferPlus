...
* Mandatory communication: `CHANGELOG.md` with a dedicated "Breaking changes v5.0.0" section + the v4→v5 migration guide (Action Plan, Phase 6) published *together with* the release, not after.
...
* v4.x consumers absorb a concentrated, real migration cost at v5.0.0 — mitigated by the dedicated migration guide (Phase 6), but the cost exists.
