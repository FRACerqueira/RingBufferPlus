...
namespace RingBufferPlusTest.ObjectValues
{
    public class RingBufferMetricTest
    {
        ...
        {
            var featureTest = new RingBufferMetric("Alias", 2, 3, 4, 5, 6, 7, 8, 9, 10, TimeSpan.Zero, TimeSpan.FromMilliseconds(10));
            ...
            Assert.Equal(TimeSpan.Zero, featureTest.AverageSucceededExecution);
            Assert.Equal(10, featureTest.AcquisitionSucceededCount);
        }
    }
}
