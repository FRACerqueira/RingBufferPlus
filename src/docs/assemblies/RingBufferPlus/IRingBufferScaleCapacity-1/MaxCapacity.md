...
### IRingBufferScaleCapacity&lt;T&gt;.MaxCapacity method
</br>
...
```csharp
public IRingBufferScaleCapacity MaxCapacity(int value)
```

| parameter | description |
| --- | --- |
| value | The maximum buffer capacity. Value must be greater than or equal to the minimum capacity. |
